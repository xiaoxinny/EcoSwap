...
import http from "../../../EcoSwap-amos/amos/client/src/http";
import dayjs from "dayjs";
import UserContext from "../../../EcoSwap-amos/amos/client/src/contexts/UserContext";
import global from "../../../EcoSwap-amos/amos/client/src/global";
...
function Tutorials() {
  ...
  useEffect(() => {
    console.log("Current user:", user); // Log the user to see if it is being set
  }, [user]);
